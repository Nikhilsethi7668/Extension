...
const DEFAULT_CONFIG = {
  apiUrl: process.env.API_BASE_URL || 'http://45.137.194.145:5573/api',
  apiToken: '',
...
function launchChromeProfile(profileDir) {
  try {
    ...
    if (process.platform === 'win32') {
      ...
      const chromeLocal = path.join(localAppData, 'Google', 'Chrome', 'Application', 'chrome.exe');
